# script Iterates over list of integration IDs - returns integration Code(name) and Version
import requests
...
try:
    ...
    # Extract integration codes and versions starting with 'INT_'
    integrations_info = [
        f"{integration['code']}|{integration['version']}"
