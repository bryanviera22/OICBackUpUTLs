# https://docs.oracle.com/en/cloud/paas/integration-cloud/rest-api/op-ic-api-integration-v1-integrations-id-archive-get.html
...
#.txt file includes code name, version, status, and integration's last updated date
#MUST INSTALL the requests library in order to use this script: pip install requests
