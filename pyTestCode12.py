#input instance, username, and password
...
# Input your Oracle Integration Cloud details
OIC_INSTANCE = input('Enter OIC Instance: ')
OIC_USERNAME = input('Enter OIC Username: ')
OIC_PASSWORD = input('Enter OIC Password: ')
